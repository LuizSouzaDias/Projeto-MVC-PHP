...
class Usuarios
{
    ...
    public function editar(){         //classe que ira editar um usuario cadstrado no sistema //terminar a classe
        try {
            ...
            $comando_drop = ("update usuario set nome = '$this->nome', email = '$this->email', cpf = '$this->cpf', endereco = '$this->endereco',ddd = '$this->ddd', telefone = '$this->telefone' where id = '$this->id'");
